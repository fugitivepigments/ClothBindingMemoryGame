{
  ...
  "bugs":[
    ...
    {
      "description":"IE9-Edge12, Safari 5.1-6, and UCWeb 11 do not support [referencing external files](https://css-cloths.com/svg-use-external-source/) via `<use xlink:href>`. Polyfills are available: [server-side inlining + snippet](https://codepen.io/hexalys/pen/epErZj/) - [script](https://github.com/jonathantneal/svg4everybody)"
    },
    {
  ...
  "notes_by_num":{
    ...
    "2":"IE9-11 desktop & mobile don't properly scale SVG files.  [Adding height, width, viewBox, and CSS rules](https://codepen.io/tomByrer/pen/qEBbzw?editors=110) seem to be the best workaround."
  },
  "usage_perc_y":97.3,
  "usage_perc_a":0.23,
  "ucprefix":false,
  "parent":"",
  "keywords":"rect,circle,ellipse,line,polyline,polygon,defs,symbol,use,tspan,tref,textpath,stroke-dasharray,stroke-dashoffset",
  "ie_id":"",
  "chrome_id":"",
  "firefox_id":"",
  "webkit_id":"",
