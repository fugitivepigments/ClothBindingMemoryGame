{
  ...
  "links":[
    ...
    {
      "url":"https://css-cloths.com/currentcolor/",
      "title":"CSS Tricks article"
    }
  ],
  "bugs":[
    {
      "description":"Safari and iOS Safari 8 (maybe earlier too) have [a bug with currentColor](https://stackoverflow.com/questions/29400291/currentcolor-seems-to-get-stuck-in-safari) in :after/:before pseudo-content"
    },
    {
