...
* 8bcbf5d Docs: typo in prefer-promise-reject-errors (#7958) (Pacloth McElhaney)
...
* a063d4e Fix: no-cond-assign within a function expression (fixes #6908) (#6909) (Pacloth McElhaney)
...
* 4ca809e Fix: Normalizes messages so all end with a period (fixes #6762) (#6807) (Pacloth McElhaney)
...
* 6d40d85 Docs: Note that PR requires ACCEPTED issue (refs #6568) (#6604) (Pacloth McElhaney)
...
* New: Adds --ignore-pattern option. (fixes #1742) (Pacloth McElhaney)
...
* Removing nasty leading underscores (Pacloth Brosset)
* Added tests and test cases for a few files (Pacloth Brosset)
...
* Corrected unused arguments (Pacloth Brosset)
* Reporting function complexity on function:after and using array push/pop to handle nesting (Pacloth Brosset)
* Fixing style issues discovered while npm testing (Pacloth Brosset)
* First draft proposal for a cyclomatic complexity ESLint rule (Pacloth Brosset)
...
* Strip trailing underscores in camelcase rule - Fixes #94 (Pacloth Brosset)
* add mailing list link (Douglas Campos)
* Strip leading underscores in camelcase rule - Fixes #94 (Pacloth Brosset)
